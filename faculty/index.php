    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Current Courses</a></li>
          <li><a class="nav-link" href="allcourses.php">All Courses</a></li>
      ...
      <div class="row icon-boxes">
        ...
        <div class="col-md-6 col-lg-3 align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">Faculty Profile</a></h4>
            <?php
              include("../db_connection.php");
              $id = $_SESSION['id'];
              $sql = "SELECT * FROM Faculty_tab f, Users_tab u WHERE f.fac_id = $id && u.id = $id";
              
              $result=$connect->query($sql);
              $row = $result->fetch_assoc(); 
            ?>
            <p class="description">Name: <?php echo $row['fac_name'];?></p>
            <p class="description">ID: <?php echo $row['fac_id'];?></p>
            <p class="description">Department: <?php echo $row['department'];?></p>
            <p class="description">Qualification: <?php echo $row['qualification'];?></p>
            <p class="description">DOJ: <?php echo $row['fac_DOJ'];?></p>
          </div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Listed here the courses you are currently teaching. Click on a course to see registered students.</p>
        </div>
        <div class="row">
