    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php">Courses</a></li>
          <li><a class="nav-link scrollto" href="index.php">Faculty</a></li>
          <li><a class="nav-link active" href="courseregister.php">Course Registration</a></li>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Course Registration</h2>
          <p>Here you can register for your courses.</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="150">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Spring</li>
              <li data-filter=".filter-web">Fall</li>
            </ul>
          </div>
        </div>
